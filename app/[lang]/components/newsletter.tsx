            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                <h3 className="h3 text-white mb-2">
                  {/*
                  // @ts-ignore */}
                  {t('newsletter_CTA_content_header')}
                </h3>
                <p className="text-gray-300 text-lg mb-6">
                  {/*
                  // @ts-ignore */}
                  {t('newsletter_CTA_content_body')}
                </p>
                {/* CTA form */}
                <form className="w-full lg:w-auto">
                  <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:mx-0">
                    ...
                    /*
                    // @ts-ignore */
                    placeholder={t('newsletter_CTA_placeholder_email')}
                    /*
                    // @ts-ignore */
                    aria-label={t('newsletter_CTA_label_email')}
                    />
                    <a className="btn text-white bg-blue-600 hover:bg-blue-700 shadow" href="#0">
                      {/*
                      // @ts-ignore */}
                      {t('newsletter_CTA_from_subscribe')}
                    </a>
                  </div>
                  {/* Success message */}
                  ...
                  <p className="text-sm text-gray-400 mt-3">
                    {/*
                    // @ts-ignore */}
                    {t('newsletter_CTA_success_message_unsubscribe')}
                  </p>
                </form>
              </div>
